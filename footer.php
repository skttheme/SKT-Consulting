...
<div class="container">
     <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-consulting');?> <a href="<?php echo esc_url('https://www.sktthemes.org/product-category/business-wordpress-themes/');?>" target="_blank">
        <?php esc_html_e('SKT Business Themes','skt-consulting'); ?>
        </a></div>
     <div class="clear"></div>
</div>           
</div>
