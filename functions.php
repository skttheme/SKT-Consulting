...
define('SKT_CONSULTING_SKTTHEMES_URL','https://www.sktthemes.org');
define('SKT_CONSULTING_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/financial-advisor-wordpress-theme');
define('SKT_CONSULTING_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-financial-wordpress-theme');
define('SKT_CONSULTING_SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/consulting-pro-documentation');
define('SKT_CONSULTING_SKTTHEMES_LIVE_DEMO','https://www.sktperfectdemo.com/demos/sktconsulting');
define('SKT_CONSULTING_SKTTHEMES_THEMES','https://www.sktthemes.org/themes/');
/**
...
add_action( 'tgmpa_register', 'skt_consulting_register_required_plugins' );
 
function skt_consulting_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'SKT Templates',
			'slug'      => 'skt-templates',
